...
var vec__7962 = axis;
var a_x = cljs.core.nth.call(null,vec__7962,(0),null);
var a_y = cljs.core.nth.call(null,vec__7962,(1),null);
var a_z = cljs.core.nth.call(null,vec__7962,(2),null);
var vec__7965 = v;
var x = cljs.core.nth.call(null,vec__7965,(0),null);
var y = cljs.core.nth.call(null,vec__7965,(1),null);
var z = cljs.core.nth.call(null,vec__7965,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__7968,p__7969){
var vec__7970 = p__7968;
var u1 = cljs.core.nth.call(null,vec__7970,(0),null);
var u2 = cljs.core.nth.call(null,vec__7970,(1),null);
var u3 = cljs.core.nth.call(null,vec__7970,(2),null);
var vec__7973 = p__7969;
var v1 = cljs.core.nth.call(null,vec__7973,(0),null);
var v2 = cljs.core.nth.call(null,vec__7973,(1),null);
var v3 = cljs.core.nth.call(null,vec__7973,(2),null);
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__7977_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__7978_SHARP_,angle_lr),angle_ud);
...
var map__7980 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__7980__$1 = ((((!((map__7980 == null)))?(((((map__7980.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7980.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7980):map__7980);
var up = cljs.core.get.call(null,map__7980__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__7980__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__7982 = cljs.core._EQ_;
var expr__7983 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__7982.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__7983))){
return straight;
} else {
if(cljs.core.truth_(pred__7982.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__7983))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__7982.call(null,quil.middlewares.navigation_3d.space,expr__7983))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__7982.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__7983))){
return up;
} else {
if(cljs.core.truth_(pred__7982.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__7983))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__7982.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__7983))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__7980,map__7980__$1,up,straight){
return (function (p1__7979_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__7979_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__7980,map__7980__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__7985_SHARP_);
});})(initial_state))
);
});
/**
...
var map__7986_7997 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__7986_7998__$1 = ((((!((map__7986_7997 == null)))?(((((map__7986_7997.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7986_7997.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7986_7997):map__7986_7997);
var vec__7987_7999 = cljs.core.get.call(null,map__7986_7998__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_8000 = cljs.core.nth.call(null,vec__7987_7999,(0),null);
var c_y_8001 = cljs.core.nth.call(null,vec__7987_7999,(1),null);
var c_z_8002 = cljs.core.nth.call(null,vec__7987_7999,(2),null);
var vec__7990_8003 = cljs.core.get.call(null,map__7986_7998__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_8004 = cljs.core.nth.call(null,vec__7990_8003,(0),null);
var u_y_8005 = cljs.core.nth.call(null,vec__7990_8003,(1),null);
var u_z_8006 = cljs.core.nth.call(null,vec__7990_8003,(2),null);
var vec__7993_8007 = cljs.core.get.call(null,map__7986_7998__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_8008 = cljs.core.nth.call(null,vec__7993_8007,(0),null);
var p_y_8009 = cljs.core.nth.call(null,vec__7993_8007,(1),null);
var p_z_8010 = cljs.core.nth.call(null,vec__7993_8007,(2),null);
quil.core.camera.call(null,p_x_8008,p_y_8009,p_z_8010,(p_x_8008 + c_x_8000),(p_y_8009 + c_y_8001),(p_z_8010 + c_z_8002),u_x_8004,u_y_8005,u_z_8006);
