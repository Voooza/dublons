...
var vec__10255 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__10255,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__10255,(1),null);
var ab = cljs.core.nth.call(null,vec__10255,(2),null);
...
if(!((m__4244__auto__ == null))){
return m__4244__auto__.call(null,a,b);
} else {
var m__4244__auto____$1 = (clojure.data.diff_similar["_"]);
if(!((m__4244__auto____$1 == null))){
return m__4244__auto____$1.call(null,a,b);
} else {
...
return (function (){var G__10264 = clojure.data.equality_partition.call(null,a);
var G__10264__$1 = (((G__10264 instanceof cljs.core.Keyword))?G__10264.fqn:null);
switch (G__10264__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10264__$1)].join('')));
