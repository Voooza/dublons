...
var G__8837 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__8837,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__8837;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq8839){
var G__8840 = cljs.core.first.call(null,seq8839);
var seq8839__$1 = cljs.core.next.call(null,seq8839);
var G__8841 = cljs.core.first.call(null,seq8839__$1);
var seq8839__$2 = cljs.core.next.call(null,seq8839__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8840,G__8841,seq8839__$2);
});
...
var file = cljs.core.get.call(null,map__8846__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__8846__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__8846__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__8846,map__8846__$1,file,line,column){
return (function (p1__8845_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__8845_SHARP_));
});})(map__8846,map__8846__$1,file,line,column))
...
var temp__5457__auto___8848 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___8848)){
var message_8849 = temp__5457__auto___8848;
cljs.core.println.call(null,message_8849);
} else {
}
...
var temp__5457__auto___8850 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___8850)){
var message_8851 = temp__5457__auto___8850;
cljs.core.println.call(null,message_8851);
} else {
}
...
var output_dir__$1 = (function (){var G__8852 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__8852),"/"].join('');
} else {
return G__8852;
}
})();
...
var G__8854 = exception.stack;
var G__8854__$1 = (((G__8854 == null))?null:clojure.string.split_lines.call(null,G__8854));
var G__8854__$2 = (((G__8854__$1 == null))?null:cljs.core.get.call(null,G__8854__$1,depth));
if((G__8854__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__8854__$2);
}
} else {
...
var vec__8855 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__8855,(0),null);
var column = cljs.core.nth.call(null,vec__8855,(1),null);
var vec__8858 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__8858,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__8858,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__8858,(2),null);
...
var m__$1 = (function (){var G__8861 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__8865 = (function (){var G__8864 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__8864);
} else {
return G__8864;
}
})();
...
return cljs.core.vary_meta.call(null,G__8866,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e8867){var e = e8867;
var G__8868 = e;
var G__8868__$1 = (((G__8868 instanceof cljs.core.Keyword))?G__8868.fqn:null);
switch (G__8868__$1) {
...
var vec__8870 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__8870,(0),null);
var types = vec__8870;
...
return cljs.core.map.call(null,(function (p__8873){
var vec__8874 = p__8873;
var ns = cljs.core.nth.call(null,vec__8874,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__8874,(1),null);
return ((function (vec__8874,ns,vars__$1){
return (function (){
...
var G__8877 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__8877,G__8877__$1,env,once_fixtures,each_fixtures,vec__8874,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__8877,G__8877__$1,env,once_fixtures,each_fixtures,vec__8874,ns,vars__$1){
return (function (){
var seq__8878 = cljs.core.seq.call(null,vars__$1);
var chunk__8879 = null;
var count__8880 = (0);
var i__8881 = (0);
while(true){
if((i__8881 < count__8880)){
var v = cljs.core._nth.call(null,chunk__8879,i__8881);
var temp__5457__auto___8883 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___8883)){
var t_8884 = temp__5457__auto___8883;
each_fixture_fn.call(null,((function (seq__8878,chunk__8879,count__8880,i__8881,t_8884,temp__5457__auto___8883,v,each_fixture_fn,G__8877,G__8877__$1,env,once_fixtures,each_fixtures,vec__8874,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_8884)));
});})(seq__8878,chunk__8879,count__8880,i__8881,t_8884,temp__5457__auto___8883,v,each_fixture_fn,G__8877,G__8877__$1,env,once_fixtures,each_fixtures,vec__8874,ns,vars__$1))
);
} else {
}


var G__8885 = seq__8878;
var G__8886 = chunk__8879;
var G__8887 = count__8880;
var G__8888 = (i__8881 + (1));
seq__8878 = G__8885;
chunk__8879 = G__8886;
count__8880 = G__8887;
i__8881 = G__8888;
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__8878);
if(temp__5457__auto__){
var seq__8878__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__8878__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__8878__$1);
var G__8889 = cljs.core.chunk_rest.call(null,seq__8878__$1);
var G__8890 = c__4351__auto__;
var G__8891 = cljs.core.count.call(null,c__4351__auto__);
var G__8892 = (0);
seq__8878 = G__8889;
chunk__8879 = G__8890;
count__8880 = G__8891;
...
var v = cljs.core.first.call(null,seq__8878__$1);
var temp__5457__auto___8893__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___8893__$1)){
var t_8894 = temp__5457__auto___8893__$1;
each_fixture_fn.call(null,((function (seq__8878,chunk__8879,count__8880,i__8881,t_8894,temp__5457__auto___8893__$1,v,seq__8878__$1,temp__5457__auto__,each_fixture_fn,G__8877,G__8877__$1,env,once_fixtures,each_fixtures,vec__8874,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_8894)));
});})(seq__8878,chunk__8879,count__8880,i__8881,t_8894,temp__5457__auto___8893__$1,v,seq__8878__$1,temp__5457__auto__,each_fixture_fn,G__8877,G__8877__$1,env,once_fixtures,each_fixtures,vec__8874,ns,vars__$1))
);
} else {
}


var G__8895 = cljs.core.next.call(null,seq__8878__$1);
var G__8896 = null;
var G__8897 = (0);
var G__8898 = (0);
seq__8878 = G__8895;
...
});})(each_fixture_fn,G__8877,G__8877__$1,env,once_fixtures,each_fixtures,vec__8874,ns,vars__$1))
);
});})(each_fixture_fn,G__8877,G__8877__$1,env,once_fixtures,each_fixtures,vec__8874,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__8877__$1)].join('')));

}
})());
});
;})(vec__8874,ns,vars__$1))
