...
var len__4531__auto___10154 = arguments.length;
var i__4532__auto___10155 = (0);
while(true){
if((i__4532__auto___10155 < len__4531__auto___10154)){
args__4534__auto__.push((arguments[i__4532__auto___10155]));

var G__10156 = (i__4532__auto___10155 + (1));
i__4532__auto___10155 = G__10156;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10151){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10152,G__10153,seq10151__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10157_SHARP_){
return !((cljs.core.meta.call(null,p1__10157_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__10158__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e10162){var _e__9142__auto__ = e10162;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e10164){var _e__9142__auto__ = e10164;
return false;
}}
})())){
...
var _STAR_current_state_STAR_10166 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__10167 = opts;
...
var markup_db = cljs.core.get.call(null,map__10167__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_10166;
}});
...
;
var temp__5455__auto___10171 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___10171)){
var managed_print_level_10172 = temp__5455__auto___10171;
var _STAR_print_level_STAR_10170_10173 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_10172;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_10170_10173,managed_print_level_10172,temp__5455__auto___10171,writer,opts,job_fn){
return (function (p1__10169_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10169_SHARP_,null);
});})(_STAR_print_level_STAR_10170_10173,managed_print_level_10172,temp__5455__auto___10171,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_10170_10173;
}} else {
job_fn.call(null);
}
