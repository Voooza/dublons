...
var G__10125 = devtools.prefs.pref.call(null,v);
v = G__10125;
continue;
} else {
return v;
...
}catch (e10128){var _e__9142__auto__ = e10128;
return false;
}})();
...
}catch (e10132){var _e__9142__auto__ = e10132;
return false;
}})();
...
}catch (e10134){var _e__9142__auto__ = e10134;
return false;
}}
}
});
...
var vec__10136 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10136,(0),null);
var name = cljs.core.nth.call(null,vec__10136,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10139_SHARP_);
}),template);
});
