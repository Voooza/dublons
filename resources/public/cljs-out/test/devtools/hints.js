...
var temp__5455__auto__ = cljs.core.deref.call(null,devtools.hints.processed_errors);
...
var reader = (function (){var or__3949__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__3949__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
return (128);
...
var map__11216 = top_item;
var map__11216__$1 = ((((!((map__11216 == null)))?(((((map__11216.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11216.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11216):map__11216);
var file = cljs.core.get.call(null,map__11216__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11216__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11216__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e11215){var _e = e11215;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___11218 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___11218)){
var seen_errors_11219 = temp__5455__auto___11218;
if(cljs.core.truth_(seen_errors_11219.has(self))){
} else {
seen_errors_11219.add(self);

var temp__5457__auto___11220 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___11220)){
var sense_11221 = temp__5457__auto___11220;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11221)].join('');
} else {
}
}
} else {
...
var temp__5457__auto__ = devtools.hints.error_object_sense.call(null,error);
if(cljs.core.truth_(temp__5457__auto__)){
var sense = temp__5457__auto__;
