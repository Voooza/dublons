...
var G__15956 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__15956,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__15956;
}
});
...
var len__4531__auto___15961 = arguments.length;
var i__4532__auto___15962 = (0);
while(true){
if((i__4532__auto___15962 < len__4531__auto___15961)){
args__4534__auto__.push((arguments[i__4532__auto___15962]));

var G__15963 = (i__4532__auto___15962 + (1));
i__4532__auto___15962 = G__15963;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq15958){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15959,G__15960,seq15958__$2);
});
...
var map__15965 = m;
var map__15965__$1 = ((((!((map__15965 == null)))?(((((map__15965.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15965.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15965):map__15965);
var file = cljs.core.get.call(null,map__15965__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15965__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15965__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__15965,map__15965__$1,file,line,column){
return (function (p1__15964_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__15964_SHARP_));
});})(map__15965,map__15965__$1,file,line,column))
...
var temp__5457__auto___15967 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___15967)){
var message_15968 = temp__5457__auto___15967;
cljs.core.println.call(null,message_15968);
} else {
}
...
var temp__5457__auto___15969 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___15969)){
var message_15970 = temp__5457__auto___15969;
cljs.core.println.call(null,message_15970);
} else {
}
...
var output_dir__$1 = (function (){var G__15971 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15971),"/"].join('');
} else {
return G__15971;
}
})();
...
var G__15973 = exception.stack;
var G__15973__$1 = (((G__15973 == null))?null:clojure.string.split_lines.call(null,G__15973));
var G__15973__$2 = (((G__15973__$1 == null))?null:cljs.core.get.call(null,G__15973__$1,depth));
if((G__15973__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__15973__$2);
}
} else {
...
var vec__15974 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__15974,(0),null);
var column = cljs.core.nth.call(null,vec__15974,(1),null);
var vec__15977 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__15977,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__15977,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__15977,(2),null);
...
var m__$1 = (function (){var G__15980 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__15984 = (function (){var G__15983 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__15983);
} else {
return G__15983;
}
})();
...
return cljs.core.vary_meta.call(null,G__15985,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__15989 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__15989,(0),null);
var types = vec__15989;
...
return cljs.core.map.call(null,(function (p__15992){
var vec__15993 = p__15992;
var ns = cljs.core.nth.call(null,vec__15993,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__15993,(1),null);
return ((function (vec__15993,ns,vars__$1){
return (function (){
...
var G__15996 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__15996__$1 = (((G__15996 instanceof cljs.core.Keyword))?G__15996.fqn:null);
switch (G__15996__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__15996,G__15996__$1,env,once_fixtures,each_fixtures,vec__15993,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__15996,G__15996__$1,env,once_fixtures,each_fixtures,vec__15993,ns,vars__$1){
return (function (){
var seq__15997 = cljs.core.seq.call(null,vars__$1);
var chunk__15998 = null;
var count__15999 = (0);
var i__16000 = (0);
while(true){
if((i__16000 < count__15999)){
var v = cljs.core._nth.call(null,chunk__15998,i__16000);
var temp__5457__auto___16002 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___16002)){
var t_16003 = temp__5457__auto___16002;
each_fixture_fn.call(null,((function (seq__15997,chunk__15998,count__15999,i__16000,t_16003,temp__5457__auto___16002,v,each_fixture_fn,G__15996,G__15996__$1,env,once_fixtures,each_fixtures,vec__15993,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_16003)));
});})(seq__15997,chunk__15998,count__15999,i__16000,t_16003,temp__5457__auto___16002,v,each_fixture_fn,G__15996,G__15996__$1,env,once_fixtures,each_fixtures,vec__15993,ns,vars__$1))
);
} else {
}


var G__16004 = seq__15997;
var G__16005 = chunk__15998;
var G__16006 = count__15999;
var G__16007 = (i__16000 + (1));
seq__15997 = G__16004;
chunk__15998 = G__16005;
count__15999 = G__16006;
i__16000 = G__16007;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__15997);
if(temp__5457__auto__){
var seq__15997__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__15997__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__15997__$1);
var G__16008 = cljs.core.chunk_rest.call(null,seq__15997__$1);
var G__16009 = c__4351__auto__;
var G__16010 = cljs.core.count.call(null,c__4351__auto__);
var G__16011 = (0);
seq__15997 = G__16008;
chunk__15998 = G__16009;
count__15999 = G__16010;
i__16000 = G__16011;
continue;
} else {
var v = cljs.core.first.call(null,seq__15997__$1);
var temp__5457__auto___16012__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___16012__$1)){
var t_16013 = temp__5457__auto___16012__$1;
each_fixture_fn.call(null,((function (seq__15997,chunk__15998,count__15999,i__16000,t_16013,temp__5457__auto___16012__$1,v,seq__15997__$1,temp__5457__auto__,each_fixture_fn,G__15996,G__15996__$1,env,once_fixtures,each_fixtures,vec__15993,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_16013)));
});})(seq__15997,chunk__15998,count__15999,i__16000,t_16013,temp__5457__auto___16012__$1,v,seq__15997__$1,temp__5457__auto__,each_fixture_fn,G__15996,G__15996__$1,env,once_fixtures,each_fixtures,vec__15993,ns,vars__$1))
);
} else {
}


var G__16014 = cljs.core.next.call(null,seq__15997__$1);
var G__16015 = null;
var G__16016 = (0);
var G__16017 = (0);
seq__15997 = G__16014;
chunk__15998 = G__16015;
count__15999 = G__16016;
i__16000 = G__16017;
continue;
}
} else {
...
});})(each_fixture_fn,G__15996,G__15996__$1,env,once_fixtures,each_fixtures,vec__15993,ns,vars__$1))
);
});})(each_fixture_fn,G__15996,G__15996__$1,env,once_fixtures,each_fixtures,vec__15993,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15996__$1)].join('')));

}
})());
});
;})(vec__15993,ns,vars__$1))
