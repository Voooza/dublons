...
/** @define {string} */
goog.define("cljs_test_display.core.root_node_id","app");

/** @define {boolean} */
goog.define("cljs_test_display.core.change_favicon",true);

/** @define {boolean} */
goog.define("cljs_test_display.core.notifications",true);

/** @define {boolean} */
goog.define("cljs_test_display.core.printing",false);
...
var len__4531__auto___8470 = arguments.length;
var i__4532__auto___8471 = (0);
while(true){
if((i__4532__auto___8471 < len__4531__auto___8470)){
args__4534__auto__.push((arguments[i__4532__auto___8471]));

var G__8472 = (i__4532__auto___8471 + (1));
i__4532__auto___8471 = G__8472;
continue;
} else {
}
break;
...
return cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4535__auto__);
});
...
return goog.dom.createTextNode([cljs.core.str.cljs$core$IFn$_invoke$arity$1(x)].join(''));
} else {
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq8467){
var G__8468 = cljs.core.first.call(null,seq8467);
var seq8467__$1 = cljs.core.next.call(null,seq8467);
var G__8469 = cljs.core.first.call(null,seq8467__$1);
var seq8467__$2 = cljs.core.next.call(null,seq8467__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8468,G__8469,seq8467__$2);
});
...
var vec__8473 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__8473,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__8473,(1),null);
var G__8476 = cljs.core.PersistentArrayMap.EMPTY;
var G__8476__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__8476,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8476);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__8476__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__8476__$1;
}
} else {
...
return (function() { 
var G__8480__delegate = function (klass,contents){
var vec__8477 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__8477,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__8477,(1),null);
...
var G__8480 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__8481__i = 0, G__8481__a = new Array(arguments.length -  1);
while (G__8481__i < G__8481__a.length) {G__8481__a[G__8481__i] = arguments[G__8481__i + 1]; ++G__8481__i;}
  contents = new cljs.core.IndexedSeq(G__8481__a,0,null);
} 
return G__8480__delegate.call(this,klass,contents);};
G__8480.cljs$lang$maxFixedArity = 1;
G__8480.cljs$lang$applyTo = (function (arglist__8482){
var klass = cljs.core.first(arglist__8482);
var contents = cljs.core.rest(arglist__8482);
return G__8480__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__8486){
var map__8487 = p__8486;
var map__8487__$1 = ((((!((map__8487 == null)))?(((((map__8487.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8487.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8487):map__8487);
var ns = cljs.core.get.call(null,map__8487__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__8487__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__8489){
...
var actual = cljs.core.get.call(null,map__8490__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__8490__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
var node = cljs_test_display.core.div.call(null,new cljs.core.Keyword(null,"test-fail","test-fail",-1337227951),cljs_test_display.core.contexts_node.call(null),cljs_test_display.core.div.call(null,new cljs.core.Keyword(null,"fail-body","fail-body",91617623),(function (){var temp__5457__auto__ = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto__)){
var message = temp__5457__auto__;
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__8492){
var map__8493 = p__8492;
var map__8493__$1 = ((((!((map__8493 == null)))?(((((map__8493.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8493.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8493):map__8493);
var expected = cljs.core.get.call(null,map__8493__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__8493__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__8495_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__8497 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__8497__$1;
var name = cljs.core.get.call(null,map__8497__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__8497__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8497__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__8497,map__8497__$1,info,name,line,file,node){
return (function (p1__8496_SHARP_){
return cljs.core.cons.call(null,node,p1__8496_SHARP_);
});})(curr_node,map__8497,map__8497__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__8499){
var map__8500 = p__8499;
var map__8500__$1 = ((((!((map__8500 == null)))?(((((map__8500.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8500.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8500):map__8500);
var m = map__8500__$1;
var fail = cljs.core.get.call(null,map__8500__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__8500__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__8500__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__8500__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
goog.dom.classlist.add(report_header,(cljs.core.truth_(cljs_test_display.core.failed_QMARK_.call(null,m))?"tests-fail":"tests-succeed"));
...
var temp__5457__auto___8502 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___8502)){
var message_8503 = temp__5457__auto___8502;
cljs.core.println.call(null,message_8503);
} else {
}
...
var temp__5457__auto___8504 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___8504)){
var message_8505 = temp__5457__auto___8504;
cljs.core.println.call(null,message_8505);
} else {
}
...
if(cljs.core.truth_(cljs_test_display.core.failed_QMARK_.call(null,m))){
...
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["cljs-test-display: Element with id ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs_test_display.core.root_node_id))," does not exist."].join('')),"\n","(gdom/getElement (name root-node-id))"].join('')));
}
