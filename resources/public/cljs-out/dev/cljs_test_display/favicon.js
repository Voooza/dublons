...
return html_coll.item(p1__8391_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__8392_SHARP_);
...
var ctx_8393 = cvs.getContext("2d");
ctx_8393.fillStyle = color;

ctx_8393.fillRect((0),(0),size,size);
