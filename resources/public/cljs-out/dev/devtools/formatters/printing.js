...
var len__4531__auto___19379 = arguments.length;
var i__4532__auto___19380 = (0);
while(true){
if((i__4532__auto___19380 < len__4531__auto___19379)){
args__4534__auto__.push((arguments[i__4532__auto___19380]));

var G__19381 = (i__4532__auto___19380 + (1));
i__4532__auto___19380 = G__19381;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq19376){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19377,G__19378,seq19376__$2);
});
...
if(cljs.core.truth_((function (){var or__3949__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
return cljs.core._write.call(null,writer__4193__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
var temp__5455__auto__ = cljs.core.first.call(null,cljs.core.first.call(null,group));
...
if(cljs.core.truth_((function (){var and__3938__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__3938__auto__){
var or__3949__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__19382_SHARP_){
return !((cljs.core.meta.call(null,p1__19382_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__19383__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e19387){var _e__18142__auto__ = e19387;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e19389){var _e__18142__auto__ = e19389;
return false;
}}
})())){
...
var temp__5455__auto__ = devtools.formatters.printing.build_markup.call(null,markup_db,new cljs.core.Keyword(null,"atomic","atomic",-120459460),obj);
if(cljs.core.truth_(temp__5455__auto__)){
...
var _STAR_current_state_STAR_19391 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__19392 = opts;
...
var markup_db = cljs.core.get.call(null,map__19392__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_19391;
}});
...
;
var temp__5455__auto___19396 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___19396)){
var managed_print_level_19397 = temp__5455__auto___19396;
var _STAR_print_level_STAR_19395_19398 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_19397;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_19395_19398,managed_print_level_19397,temp__5455__auto___19396,writer,opts,job_fn){
return (function (p1__19394_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__19394_SHARP_,null);
});})(_STAR_print_level_STAR_19395_19398,managed_print_level_19397,temp__5455__auto___19396,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_19395_19398;
}} else {
job_fn.call(null);
}
