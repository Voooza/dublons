...
var G__19325 = devtools.prefs.pref.call(null,v);
v = G__19325;
continue;
} else {
return v;
...
var and__3938__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__3938__auto__){
var and__3938__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__3949__auto__ = (function (){try{if(!((value == null))){
...
}catch (e19328){var _e__18142__auto__ = e19328;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e19332){var _e__18142__auto__ = e19332;
return false;
}})();
...
}catch (e19334){var _e__18142__auto__ = e19334;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__3938__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__3938__auto__)){
var and__3938__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__3938__auto____$1){
...
var and__3938__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__3938__auto__)){
...
var or__3949__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
var and__3938__auto__ = (function (){var or__3949__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
var vec__19336 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__19336,(0),null);
var name = cljs.core.nth.call(null,vec__19336,(1),null);
...
var and__3938__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__3938__auto__)){
...
var or__3949__auto__ = typeof value === 'string';
if(or__3949__auto__){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__19339_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__19339_SHARP_);
}),template);
});
...
var temp__5455__auto__ = devtools.formatters.helpers.pref.call(null,pref_key);
if(cljs.core.truth_(temp__5455__auto__)){
var render_pref = temp__5455__auto__;
if(render_pref === true){
