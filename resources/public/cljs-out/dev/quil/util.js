...
var or__3949__auto__ = cljs.core.last(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8844_SHARP_){
return p1__8844_SHARP_.length();
}),cljs.core.keys(m))));
...
return (function (p__8848){
var vec__8849 = p__8848;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8849,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8849,(1),null);
var len = k.length();
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8852_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__8852_SHARP_,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(["PConstants/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(quil.util.prepare_quil_name(p1__8852_SHARP_))].join(''))],null));
}),constants));
});
quil.util.prepare_quil_cljs_constants = (function quil$util$prepare_quil_cljs_constants(constants){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8853_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__8853_SHARP_,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,cljs.core.cst$sym$cljs$core_SLASH_aget,null,(1),null)),(new cljs.core.List(null,cljs.core.cst$sym$js_SLASH_Processing$prototype$PConstants,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,quil.util.prepare_quil_name(p1__8853_SHARP_),null,(1),null))], 0))))],null));
}),constants));
});
...
var ret__4565__auto___8859 = (function (){
quil.util.generate_quil_constants = (function quil$util$generate_quil_constants(var_args){
var args__4534__auto__ = [];
var len__4531__auto___8860 = arguments.length;
var i__4532__auto___8861 = (0);
while(true){
if((i__4532__auto___8861 < len__4531__auto___8860)){
args__4534__auto__.push((arguments[i__4532__auto___8861]));

var G__8862 = (i__4532__auto___8861 + (1));
i__4532__auto___8861 = G__8862;
continue;
} else {
}
break;
...
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,cljs.core.cst$sym$do,null,(1),null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8854_SHARP_){
return quil.util.make_quil_constant_map(target,cljs.core.first(p1__8854_SHARP_),cljs.core.second(p1__8854_SHARP_));
...
/** @this {Function} */
quil.util.generate_quil_constants.cljs$lang$applyTo = (function (seq8855){
...
var G__8858 = cljs.core.first(seq8855__$2);
var seq8855__$3 = cljs.core.next(seq8855__$2);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8856,G__8857,G__8858,seq8855__$3);
});
