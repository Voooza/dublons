...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__10342_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_10343 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_10344 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_10343);
var pos_10345 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_10343);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_10344);

var tr__10238__auto___10346 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_10344) - cljs.core.first(pos_10345)),(((quil.core.height() / (2)) / zoom_10344) - cljs.core.second(pos_10345))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__10238__auto___10346);
...
var G__10347 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__10348 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__10347,G__10348) : user_mouse_dragged.call(null,G__10347,G__10348));
...
return (function (state,event){
var G__10349 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__10350 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__10349,G__10350) : user_mouse_wheel.call(null,G__10349,G__10350));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
