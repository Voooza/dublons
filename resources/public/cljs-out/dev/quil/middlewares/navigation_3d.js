...
var vec__9775 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9775,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9775,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9775,(2),null);
var vec__9778 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9778,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9778,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9778,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__9781,p__9782){
var vec__9783 = p__9781;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9783,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9783,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9783,(2),null);
var vec__9786 = p__9782;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9786,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9786,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9786,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__9789_SHARP_){
return (p1__9789_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__9790_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__9791_SHARP_,angle_lr),angle_ud);
...
var map__9793 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9793__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9793__$1,cljs.core.cst$kw$straight);
var temp__5455__auto__ = (function (){var pred__9795 = cljs.core._EQ_;
var expr__9796 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((function (){var G__9798 = cljs.core.cst$kw$w;
var G__9799 = expr__9796;
return (pred__9795.cljs$core$IFn$_invoke$arity$2 ? pred__9795.cljs$core$IFn$_invoke$arity$2(G__9798,G__9799) : pred__9795.call(null,G__9798,G__9799));
})())){
return straight;
} else {
if(cljs.core.truth_((function (){var G__9800 = cljs.core.cst$kw$s;
var G__9801 = expr__9796;
return (pred__9795.cljs$core$IFn$_invoke$arity$2 ? pred__9795.cljs$core$IFn$_invoke$arity$2(G__9800,G__9801) : pred__9795.call(null,G__9800,G__9801));
})())){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__9795.cljs$core$IFn$_invoke$arity$2 ? pred__9795.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__9796) : pred__9795.call(null,quil.middlewares.navigation_3d.space,expr__9796)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((function (){var G__9802 = cljs.core.cst$kw$z;
var G__9803 = expr__9796;
return (pred__9795.cljs$core$IFn$_invoke$arity$2 ? pred__9795.cljs$core$IFn$_invoke$arity$2(G__9802,G__9803) : pred__9795.call(null,G__9802,G__9803));
})())){
return up;
} else {
if(cljs.core.truth_((function (){var G__9804 = cljs.core.cst$kw$d;
var G__9805 = expr__9796;
return (pred__9795.cljs$core$IFn$_invoke$arity$2 ? pred__9795.cljs$core$IFn$_invoke$arity$2(G__9804,G__9805) : pred__9795.call(null,G__9804,G__9805));
})())){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((function (){var G__9806 = cljs.core.cst$kw$a;
var G__9807 = expr__9796;
return (pred__9795.cljs$core$IFn$_invoke$arity$2 ? pred__9795.cljs$core$IFn$_invoke$arity$2(G__9806,G__9807) : pred__9795.call(null,G__9806,G__9807));
})())){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__5455__auto__,map__9793,map__9793__$1,up,straight){
return (function (p1__9792_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__9792_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__5455__auto__,map__9793,map__9793__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__9808_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__9809 = options;
var G__9810 = ((function (G__9809,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__9809,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__9809,G__9810) : rotate_on.call(null,G__9809,G__9810));
})();
...
var map__9811_9826 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__9811_9827__$1 = ((((!((map__9811_9826 == null)))?(((((map__9811_9826.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9811_9826.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__9811_9826):map__9811_9826);
var vec__9812_9828 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9811_9827__$1,cljs.core.cst$kw$straight);
var c_x_9829 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9812_9828,(0),null);
var c_y_9830 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9812_9828,(1),null);
var c_z_9831 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9812_9828,(2),null);
var vec__9815_9832 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9811_9827__$1,cljs.core.cst$kw$up);
var u_x_9833 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9815_9832,(0),null);
var u_y_9834 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9815_9832,(1),null);
var u_z_9835 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9815_9832,(2),null);
var vec__9818_9836 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9811_9827__$1,cljs.core.cst$kw$position);
var p_x_9837 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9818_9836,(0),null);
var p_y_9838 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9818_9836,(1),null);
var p_z_9839 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9818_9836,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_9837,p_y_9838,p_z_9839,(p_x_9837 + c_x_9829),(p_y_9838 + c_y_9830),(p_z_9839 + c_z_9831),u_x_9833,u_y_9834,u_z_9835);
...
var G__9822 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__9823 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__9822,G__9823) : key_pressed.call(null,G__9822,G__9823));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__9824 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__9825 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__9824,G__9825) : rotate_on_fn.call(null,G__9824,G__9825));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
